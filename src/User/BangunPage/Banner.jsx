...
const Banner = () => {
  return (
    <div className="px-5 pt-20 pb-7 md:py-20 md:px-20">
      <div className="rounded-xl grid grid-cols-1 lg:grid-cols-2 lg:grid-flow-row p-7 md:p-16 shadow-md md:shadow-lg md:shadow-gold shadow-gold">
        <Fade left>
          <div className="col-span-1">
            <div>
              <p className="text-2xl md:text-4xl font-bold text-tera">
                Perhatian,
              </p>
              <p className="text-2xl md:text-4xl font-bold text-tera">
                Para Pemilik Tanah!
          ...
          <div className="mt-5 text-sm md:text-lg lg:text-xl">
            <Fade left>
              ...
              <p className="text-justify">
                ...
                bekerja sama dengan Tarakota, lagi buka kesempatan nih buat
                bantu kamu wujudin impian punya perumahan atau area komersial
                keren. Gak perlu khawatirin soal biaya, kita bakal nanganin
                konsep pengembangan dan studi kelayakan tanpa harus mengeluarkan
                kocek sepeser pun.
              </p>
            </Fade>
          </div>
