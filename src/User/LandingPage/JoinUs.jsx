  ...
  return (
    ...
    >
      <div className="bg-gradient-to-r from-black via-transparent h-[40em] flex flex-col space-y-3 justify-center text-white px-20">
        ...
        Kami bertujuan untuk menjadi Firma Arsitektur dan Manufaktur Furnitur terbesar di Indonesia.
        </div>
        <button className="w-40 py-2 bg-tera text-white rounded-full font-normal hover:bg-orange-800 transition duration-300 tracking-wider">PESAN SEKARANG</button>
      </div>
    </div>
  );
};
