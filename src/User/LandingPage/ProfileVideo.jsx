    ...
    >
      <div className="md:col-span-7 lg:col-span-7 flex items-center md:col-start-2 lg:col-start-2 px-5">
        ...
        >
          ...
          <iframe className="rounded-xl md:rounded-2xl" width="100%" height="100%" src="https://www.youtube.com/embed/8nVlmEWstP0?si=J8rzWmHOKB2x-nMw" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        </Fade>
      </div>
      ...
      <div className="hidden md:col-span-3 md:col-start-9 row-start-1 items-center md:flex order-1 md:order-none">
        <div className="text-center md:text-left md:py-2">
          ...
          <div className="h-6 md:border-l-4 border-tera flex items-center">
            <p className="font-medium text-sm md:text-2xl lg:text-2xl flex-grow px-2">Video Profile</p>
          </div>
        </div>
      </div>
      </Fade>
