...
const MoreProject = () => {
  return (
    <div className='px-5 md:px-20 lg:pb-10 my-10'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 md:gap-3 gap-3 p-5 md:p-8 lg:p-10 rounded-xl md:rounded-2xl lg:rounded-3xl my-2 md:my-5 shadow-md shadow-gold'>
