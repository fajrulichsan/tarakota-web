...
const TrikAndTips = () => {
  return (
    <div className='px-5 py-5 md:px-20 lg:px-32'>
        ...
        <p className='text-sm md:text-lg lg:text-2xl text-justify md:text-center'>Dengan mengaplikasikan tips-tips ini, kamu akan berada di jalur cepat menuju kesuksesan sebagai Representatif BisnisTarakota yang berprestasi</p>
        <h1 className='text-lg md:text-2xl lg:text-4xl text-tera font-bold text-center mt-5'>Jadi, sudah siap untuk jadi Representatif BisnisTarakota yang sukses?</h1>
        <div className='grid grid-col-12 py-5 md:py-8 lg:py-16'>
            <div className='col-span-12'>
                <div className='rounded-xl md:rounded-2xl p-5 px-8 md:px-10 md:p-10 lg:px-16'
                style={{
