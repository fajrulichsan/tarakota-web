    ...
    <div className="px-5 py-5 md:py-10 md:px-20 lg:px-32">
      <Fade bottom>
        <h1 className="text-lg md:text-2xl lg:text-4xl text-tera text-center font-bold">
          Tips Menjadi Representatif BisnisTarakota Sukses
        </h1>
        ...
        <Fade bottom>
          <Slider {...settings} className="">
            {trikList.map((item) => (
              <div
                key={item.id}
                className="p-3 h-[13em] md:h-[18em] lg:h-[15em]"
              >
                <div
                  key={item.id}
      ...
      <Fade bottom>
        <p className="text-sm md:text-lg lg:text-2xl text-justify md:text-center mt-10">
          Dengan mengaplikasikan tips-tips ini, kamu akan berada di jalur cepat
          menuju kesuksesan sebagai Representatif BisnisTarakota yang
          berprestasi
        </p>
      </Fade>
      <Fade bottom>
        <h1 className="text-lg md:text-2xl lg:text-4xl text-tera font-bold text-center mt-5 md:mt-8 lg:mt-16">
          Jadi, sudah siap untuk jadi Representatif BisnisTarakota yang sukses?
        </h1>
      </Fade>
        ...
        <div className="col-span-12">
          <Fade bottom>
            <div className="rounded-xl md:rounded-2xl p-5 px-8 md:px-10 md:p-10 lg:px-16 shadow-md shadow-gold">
              <h1 className="text-sm md:text-lg lg:text-2xl font-bold text-center">
                Tips Menjadi Representatif BisnisTarakota Sukses
              </h1>
              <div className="text-sm md:text-lg lg:text-2xl mt-3 md:mt-5">
                <p>
                  Nih, contoh penghasilan sebagai Representatif BisnisTarakota:
                </p>
                <ul className="list-disc px-5 md:px-12 text-justify">
                  <li>
                    Bayangin, kamu ajak 500 orang buat ikut program
                    BisnisTarakota.
                  </li>
                  <li>
                    Dari 500 orang tersebut, ambil 2% yang tertarik sebagai
                    potential support kamu.
                  </li>
                  <li>
                    Setiap potential support yang kamu ajak bisa bantu kamu
                    dapet proyek senilai minimal 25.000.000 Rupiah per bulan.
                  </li>
                  <li>
                    Kamu bakal dapet bonus 2,5% dari proyek yang mereka dapetin.
                  </li>
                  <li>
                    Jadi, kalau semua temen kamu aktif, kamu bisa dapetin bonus
                    6.250.000 Rupiah per bulan atau 75.000.000 Rupiah per tahun!
                  </li>
                </ul>
                <p>
                  Tentu aja, ini cuma contoh. Kamu bisa dapetin lebih dari ini
                  kalau kamu kerja keras dan ajak lebih banyak orang lagi
                  sebagai tim Representatif BisnisTarakota kamu.
                </p>
              </div>
            </div>
          </Fade>
      ...
      <Fade bottom>
        <p className="text-sm md:text-lg lg:text-4xl text-tera font-semibold text-justify tracking-wider">
          Yuk, ayo segera jadi bagian dari keluarga besar kami! Setelah kamu
          bergabung, akan banyak orang lain yang akan berada di bawah naunganmu
          dan menjadi bagian dari tim suksesmu. Jangan tunda lagi, isi formulir
          di bawah ini dan jangan ragu untuk menghubungi kami sekarang! Sukses
          menanti, jadi mari kita mulai perjalanan ini bersama!
        </p>
      </Fade>
    </div>
  );
