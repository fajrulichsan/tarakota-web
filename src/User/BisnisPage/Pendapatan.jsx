    ...
    <div className="px-5 md:px-20 lg:px-32 lg:py-10">
      <Fade bottom>
        <h1 className="text-lg md:text-2xl lg:text-4xl text-tera text-center font-bold">
          Pendapatan Fantastis Representatif BisnisTarakota
        </h1>
      </Fade>
      <Fade bottom>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-8 lg:gap-10 mt-3 md:mt-10">
        <div className="col-span-1 md:col-span-12">
          <Fade bottom>
            <div className="w-full rounded-xl md:rounded-2xl p-5 md:p-7 lg:p-10 shadow-md shadow-gold">
        ...
        <div className="col-span-1 md:col-span-10 lg:col-span-8 md:col-start-2 lg:col-start-3">
          <Fade bottom>
            <div className="w-full rounded-xl md:rounded-2xl p-5 px-8 md:p-10 md:px-16 shadow-md shadow-gold">
              <ul className="list-decimal text-sm md:text-lg lg:text-2xl text-justify">
                <li>
                  ...
                  finansial yang tak terbatas sebagai Representatif
                  BisnisTarakota pada bidang arsitektur ini?
                </li>
                <li>
                ...
                <li>
                  ...
                  menggunakan platform-platform tersebut untuk membangun
                  jaringan dan mencari klien potensial?
                </li>
              </ul>
            </div>
          </Fade>
        ...
        <div className="col-span-1 md:col-span-12">
          <Fade bottom>
            <div className="w-full rounded-xl md:rounded-2xl p-5 md:p-10 shadow-md shadow-gold">
              <p className="text-sm md:text-lg lg:text-2xl text-justify">
                Pertanyaan-pertanyaan ini akan membantu kamu merenungkan apakah
                kamu cocok untuk menjadi seorang Representatif BisnisTarakota
                pada bidang arsitektur ini dengan fokus pada kebebasan
                finansial, pendapatan tak terhingga, kemampuan komunikasi,
                keaktifan di media sosial, dan kesiapan menghadapi penolakan.
              </p>
              <p className="font-bold text-sm md:text-lg lg:text-2xl">
                Gimana, kalau kamu jawab iya lebih dari 70%, berarti kamu
                mungkin cocok jadi Representatif BisnisTarakota!
              </p>
            </div>
          </Fade>
        </div>
